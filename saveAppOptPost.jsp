...
<%
	...
	sqlInsertApprovalOption="insert into post_approval (cIsApprovalNeed)"
										+"values(?)";
	
	psInsertApprovalOption=conn.prepareStatement(sqlInsertApprovalOption);
	psInsertApprovalOption.setString(1,sApprovalOptionPost);
	psInsertApprovalOption.executeUpdate();
	}
	catch(Exception e)
	{
	   e.printStackTrace();
	   response.sendRedirect("approvePostAdmin.jsp");
	}
%>
...
<title>Save Approval Post Option</title>
</head>
  ...
  <tr>
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="75%" valign="top"><h2>Post Approval Option  is Implemented successfully !</h2></td>
      </tr>
    </table>
	</td>
    <td>&nbsp;</td>
