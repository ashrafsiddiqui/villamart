...
<%
	   ...
	   try{
            String sqlOption="SELECT l.iListID, l.sUserID, l.iTransactionType, l.iPropertyID,sPropertyName, l.sPropertyAddress,"
							 ...
							 +" (select count(*) from list_requirement l where l.cStatus='A' "+addMysql+") as cnt "
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td colspan="2"><h3> City List of Property </h3></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
